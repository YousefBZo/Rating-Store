					...
					<div class="product-grid-list">
						<div class="row mt-30">
							...
							if (isset($_GET['search'])) {
								...
								echo "<script>window.open('search.php?search_value=$search_value', '_self')</script>";

							} else {
								// $select_stores = "SELECT * FROM stores limit $startFrom,$storesPerPage";
												...
												<div class="card-body">
													...
													<div class="product-ratings">
														<ul class="list-inline">
															...
															$rating = 0;
															// if (mysqli_num_rows($result_check_ip)) {
															// 	$row = mysqli_fetch_assoc($result_check_ip);
