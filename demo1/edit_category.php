...
<body>
    <div class="wrapper">
        ...
        <div class="main-panel">
            <div class="content">
                <!-- third child -->
                <form action="" method="post" class="form form-outline m-5">
                    <div class="mx-5">
                        <label for="cat_name" class="form-label my-2 fw-bold">Category Name</label>
                        <input type="text" name="cat_name" id="cat_name" placeholder="Enter category name"
                            class="form-control">
                    </div>
                    <input type="submit" value="Save" class="mx-5 my-2 bg-primary px-3 py-2 text-white border-0 rounded"
                        name="edit_cat">
                </form>
            </div>
        </div>
        ...
        if (isset($_GET['category_id'])) {
            ...
            if (isset($_POST['edit_cat'])) {
                if (!empty($_POST['cat_name'])) {
                    ...
                    $crud->editCategory($cat_name, $cat_id);
                ...
                <?php } else {
                    ...
                    <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
                    <script>
                        swal("Error", "Please fill in the input field", "error");
                    </script>
                    <?php
                }
            }
