                    ...
                    <div class="product-grid-list">
                        <div class="row mt-30">
                            ...
                            $totalPages = $crud->numTotalPagesStoresSearch($storesPerPage, $search_value);
                                ...
                                // $select_stores = "SELECT * FROM stores WHERE store_name LIKE '%$search_value%' limit $startFrom,$storesPerPage ";
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination">
                                    <li class="page-item <?php echo ($page <= 1) ? 'disabled' : ''; ?>">
                                        <a class="page-link" href="?search_value=<?php echo $search_value?>&page=<?php echo $page - 1; ?>"
                                            aria-label="Previous">
                                    ...
                                    <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                                            <li class="page-item <?php echo ($i == $page) ? 'active' : ''; ?>">
                                                <a class="page-link" href="?search_value=<?php echo $search_value?>&page=<?php echo $i; ?>"><?php echo $i; ?></a>
                                            </li>
                                    <?php endfor; ?>
                                    <li class="page-item <?php echo ($page >= $totalPages) ? 'disabled' : ''; ?>">
                                        <a class="page-link" href="?search_value=<?php echo $search_value?>&page=<?php echo $page + 1; ?>" aria-label="Next">
