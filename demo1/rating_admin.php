<?php
//start change to oop from begging
                ...
                <table class="table m-3 text-center table-hover">
                    ...
                    <tbody>
                        ...
                        if (isset($_GET['search'])) {
                            ...
                            echo "<script>window.open('search_rating.php?search_value=$search_value', '_self')</script>";
                            ...
                            foreach ($rows as $row) {
                                ...
                                $rowRate = $crud->showRating($store_id);
                                $total_ratings = 0;
                                $number_ratings = 0;
                                $store_ratings = 0;
                                // while ($row_result = mysqli_fetch_array($result_ratings)) {
                                foreach ($rowRate as $row_result) {
