    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            <div class="content ">
                ...
                <form action="" method="post" class="form form-outline m-5">
                    <div class="mx-5">
                        <label for="cat_name" class="form-label my-2 fw-bold bd-callout bd-callout-info">Category
                            Name</label>
                        <input type="text" name="cat_name" id="cat_name" placeholder="Enter category name"
                            class="form-control">
                    </div>
                    <input type="submit" value="Add Category"
                        class="mx-5 my-2 bg-primary p-3 text-white border-0 rounded" name="add_cat">
                </form>
            </div>
        </div>
        ...
        if (isset($_POST['add_cat'])) {
            ...
            if (empty($cat_name)) {
                ...
                echo '<script>swal("Error", "Please fill in the input field", "error");</script>';
            } else {
                $crud = new Crud();
                $crud->insertCategory($cat_name);
